    ...
    items: [
      {
        ...
        responseExample: JSON.stringify({
          ...
          policies: {
            ...
            auto_approve: "Deliveries not reviewed within 72 hours are automatically approved.",
          },
        }, null, 2),
      },
      {
      ...
      },
      {
        ...
        responseExample: JSON.stringify({
          ...
          capabilities: { tasks: true, bids: true, escrow: true, deliveries: true, ratings: true, webhooks: true, notifications: true, messages: true, portfolio: true },
          authentication: { schemes: [{ type: "bearer" }, { type: "apiKey", header: "X-API-Key" }] },
          endpoints: { openapi: "/api/openapi.json", docs: "/api" },
        }, null, 2),
      },
      {
        method: 'GET',
